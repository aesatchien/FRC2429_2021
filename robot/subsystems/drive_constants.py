...
k_max_speed_meters_per_second = 1.5  # 0.75 to 1.25 is pretty reasonable for the sim
k_max_acceleration_meters_per_second_squared = 1.5 # get up to full speed this fast?
