...
if real:
    ...
    # set up the wpilib kinematics model
    k_track_width_meters = 01.13  # 0.69 was from the model, 0.396 was from the characterization
...
k_max_acceleration_meters_per_second_squared = 1.5 # can we accelerate this fast?
