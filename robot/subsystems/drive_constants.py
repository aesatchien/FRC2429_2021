...
kp_drive_vel = 0.7  # this is kp for the PID on each side on top of the feed forward (0.7 seems good for 0.75 m/s)


# constants for autonomous THIS CONTROLS THE SPEEDS OF THE TRAJECTORIES GENERATED BY THIS PROGRAM
k_max_speed_meters_per_second = 1.25  # 0.75 to 1.25 is pretty reasonable for the sim
k_max_acceleration_meters_per_second_squared = 1.25 # get up to full speed this fast?
