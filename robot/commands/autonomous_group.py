...
class AutonomousGroup(CommandGroup):
    ...
    def __init__(self, robot, timeout=None):
        ...
        self.addSequential(AutonomousDrivePID(robot, setpoint=1.9, timeout=3))
        self.addSequential(AutonomousRotate(robot, setpoint=-60, timeout=3))
        self.addSequential(AutonomousDrivePID(robot, setpoint=1.0, timeout=3))
